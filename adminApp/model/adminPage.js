...
function accountSearch(){
    ...
    result.open("GET", "../controller/adminPage.php?emailsearch=" + emailsearch.value + "&usernamesearch=" + usernamesearch.value + "&phonesearch=" + phonesearch.value, true);
    result.send();
}
...
function deleteAccount(userid){
    ...
    deleteAccount.open("GET","../controller/adminPage.php?deleteaccount=" + userid, true);
    deleteAccount.send();
    }
}
...
function clickAccount(name) {
    ...
    result.open("GET", "../controller/adminPage.php?accountemail=" + name, true);
    result.send();
}
...
function deleteTransaction(id){
    ...
    if(choice === true){
        ...
        deleteRequest.onreadystatechange = function () {
            if (this.readyState === 4 && this.status === 200) {
                if(this.responseText === "true"){
                    alert('Delete Successfully');
                    clickAccount(str.substr(56,str.length-56));
                }
                if(this.responseText === "false"){
                    alert('Delete Unsuccessfully');
                }
    ...
    deleteRequest.open("GET","../controller/adminPage.php?deletetransaction=" + id, true);
    deleteRequest.send();
    }
}
...
function foodSearch(){
    ...
    foodResult.open("GET", "../controller/adminPage.php?foodname=" + foodnamesearch.value + "&foodcourse=" + foodcoursesearch.value, true);
    foodResult.send();
}
...
function deleteFood(id){
    ...
    deleteRequest.open("GET","../controller/adminPage.php?deletefood=" + id, true);
    deleteRequest.send();
    }
}
...
function vendorSearch(){
    ...
    vendorResult.open("GET", "../controller/adminPage.php?vendorname=" + vendornamesearch.value + "&vendoraddress=" + vendoraddresssearch.value, true);
    vendorResult.send();
}
...
function deleteVendor(id){
    ...
    deleteRequest.open("GET","../controller/adminPage.php?deletevendor=" + id, true);
    deleteRequest.send();
    }
}
...
function clickFood(dishname) {
    ...
    dishResult.open("GET", "../controller/adminPage.php?dishname=" + dishname, true);
    dishResult.send();
}
...
function clickVendor(dishwhere) {
    ...
    dishResult.open("GET", "../controller/adminPage.php?dishwhere=" + dishwhere, true);
    dishResult.send();
}
...
function deleteDish(dishid, mode){
    ...
    if(choice === true){
        ...
        deleteDish.onreadystatechange = function () {
            if (this.readyState === 4 && this.status === 200) {
                if(this.responseText === "true"){
                    alert('Delete Successfully');
                    if(mode === 1)clickVendor(str.substr(56,str.length-56));
                    if(mode === 2)clickFood(str.substr(56,str.length-56));
                }
                if(this.responseText === "false"){
                    alert('Delete Unsuccessfully');
                }
    ...
    deleteDish.open("GET","../controller/adminPage.php?deletedish=" + dishid, true);
    deleteDish.send();
    }
}
...
function editDish(dishid, mode){
    ...
    if(pr !== null){
        ...
        if(!isNaN(price) && price !== 0){
            ...
            editDish.open("GET","../controller/adminPage.php?editdish=" + dishid +"&editprice=" + price, true);
            editDish.send();
        }
...
function checkFood() {  
    ...
    check.open("GET", "../controller/adminPage.php?checkfood=" + document.getElementById("addfoodname").value, true);
    check.send();
}
...
function addFood(){
    ...
    add.open("GET", "../controller/adminPage.php?addfoodname=" + document.getElementById("addfoodname").value
...
function checkVendor() {  
    ...
    check.open("GET", "../controller/adminPage.php?checkvendorname=" + document.getElementById("addvendorname").value + "&checkvendoraddress=" + document.getElementById("addvendoraddress").value, true);
    check.send();
}
...
function addVendor(){
    ...
    add.open("GET", "../controller/adminPage.php?addvendorname=" + document.getElementById("addvendorname").value
...
function saveAccount(){
    ...
    result.open("GET", "../controller/adminPage.php?passwordedit=" + i1 
                                    + "&phoneedit=" + i2 
                                    + "&addressedit=" + i3 
                                    + "&fnameedit=" + i4 
                                    + "&lnameedit=" + i5 
