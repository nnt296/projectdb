...
function accountSearch(){
    ...
    result.open("GET", "../model/adminPage.php?emailsearch=" + emailsearch.value + "&usernamesearch=" + usernamesearch.value + "&phonesearch=" + phonesearch.value, true);
    result.send();
}
...
function deleteAccount(userid){
    ...
    deleteAccount.open("GET","../model/adminPage.php?deleteaccount=" + userid, true);
    deleteAccount.send();
    }
}
...
function clickAccount(name) {
    ...
    result.open("GET", "../model/adminPage.php?accountemail=" + name, true);
    result.send();
}
...
function deleteTransaction(id){
    ...
    deleteRequest.open("GET","../model/adminPage.php?deletetransaction=" + id, true);
    deleteRequest.send();
    }
}
...
function foodSearch(){
    ...
    foodResult.open("GET", "../model/adminPage.php?foodname=" + foodnamesearch.value + "&foodcourse=" + foodcoursesearch.value, true);
    foodResult.send();
}
...
function deleteFood(id){
    ...
    deleteRequest.open("GET","../model/adminPage.php?deletefood=" + id, true);
    deleteRequest.send();
    }
}
...
function vendorSearch(){
    ...
    vendorResult.open("GET", "../model/adminPage.php?vendorname=" + vendornamesearch.value + "&vendoraddress=" + vendoraddresssearch.value, true);
    vendorResult.send();
}
...
function deleteVendor(id){
    ...
    deleteRequest.open("GET","../model/adminPage.php?deletevendor=" + id, true);
    deleteRequest.send();
    }
}
...
function clickFood(dishname) {
    ...
    dishResult.open("GET", "../model/adminPage.php?dishname=" + dishname, true);
    dishResult.send();
}
...
function clickVendor(dishwhere) {
    ...
    dishResult.open("GET", "../model/adminPage.php?dishwhere=" + dishwhere, true);
    dishResult.send();
}
...
function deleteDish(dishid, mode){
    ...
    deleteDish.open("GET","../model/adminPage.php?deletedish=" + dishid, true);
    deleteDish.send();
    }
}
...
function editDish(dishid, mode){
    ...
    if(pr !== null){
        ...
        if(!isNaN(price) && price !== 0){
            ...
            editDish.open("GET","../model/adminPage.php?editdish=" + dishid +"&editprice=" + price, true);
            editDish.send();
        }
...
function checkFood() {  
    ...
    check.open("GET", "../model/adminPage.php?checkfood=" + document.getElementById("addfoodname").value, true);
    check.send();
}
...
function addFood(){
    ...
    add.open("GET", "../model/adminPage.php?addfoodname=" + document.getElementById("addfoodname").value
...
function checkVendor() {  
    ...
    check.open("GET", "../model/adminPage.php?checkvendorname=" + document.getElementById("addvendorname").value + "&checkvendoraddress=" + document.getElementById("addvendoraddress").value, true);
    check.send();
}
...
function saveAccount(){
    ...
    result.open("GET", "../model/adminPage.php?passwordedit=" + i1 
                                    + "&phoneedit=" + i2 
                                    + "&addressedit=" + i3 
                                    + "&fnameedit=" + i4 
                                    + "&lnameedit=" + i5 
